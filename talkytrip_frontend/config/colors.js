...
export const purple = "#cf6b4e";
export const lightGray = "#ECEFF1";
export const darkBlue = "#0c293c";
export const dark = "#09151C";
export const darkSecondary = "#cf6b4e";
export const secondaryLight = "#ffbb9b";
...
export const chartColors = ["#1F77B4", "#FF7F0E", "#2CA02C", "#D62728", "#9467BD", "#8C564B", "#CFECF9", "#7F7F7F", "#BCBD22", "#17BECF", "#F8F8F8"];
